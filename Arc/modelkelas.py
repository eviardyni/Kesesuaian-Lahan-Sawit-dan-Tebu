...
def export_to_geojson(hasil: pd.DataFrame, output_path: Path) -> None:
    ...
    try:
        ...
        cols_to_keep = [
            # Koordinat
            'LON', 'LAT',
            # Kolom Data Iklim dan Terrain
            'T2M_Jan', 'T2M_Feb', 'T2M_Mar', 'T2M_Apr', 'T2M_Mei', 'T2M_Jun', 
            'T2M_Jul', 'T2M_Agu', 'T2M_Sep', 'T2M_Okt', 'T2M_Nov', 'T2M_Des',
            'CH_Jan', 'CH_Feb', 'CH_Mar', 'CH_Apr', 'CH_Mei', 'CH_Jun',
            'CH_Jul', 'CH_Agu', 'CH_Sep', 'CH_Okt', 'CH_Nov', 'CH_Des',
            'CH_THN_calc', 'slope_percent', 'BK_max',
            # Scores Sawit
            'score_T', 'score_CH', 'score_BK', 'score_SLP', 'score_total',
            'T_cls', 'CH_cls', 'BK_cls', 'SLP_cls',
            'kelas', 'kelas_crisp',
            # Scores Tebu
            'score_T_tebu', 'score_CH_tebu', 'score_BK_tebu', 'score_SLP_tebu', 'score_total_tebu',
            'T_tebu_cls', 'CH_tebu_cls', 'BK_tebu_cls', 'SLP_tebu_cls',
